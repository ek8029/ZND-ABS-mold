              ...
              >
                <div className={i % 2 === 1 ? "lg:order-2" : ""}>
                  ...
                  <div className="flex gap-3">
                    <a href="tel:+18005550199" className="btn-amber text-sm py-2.5">
                      <Phone className="w-4 h-4" />
                      Call Now
                    </a>
                    <Link href="/contact">
      ...
      <section className="py-16 bg-[#F59E0B]">
        <div className="container text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a href="tel:+18005550199" className="inline-flex items-center gap-2 bg-[#0B1F3A] text-white px-6 py-3 font-bold uppercase tracking-wider text-sm hover:bg-[#0d2545] transition-colors"
